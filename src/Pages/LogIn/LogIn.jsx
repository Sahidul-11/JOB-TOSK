...
const LogIn = () => {
    const {user , loading ,googleLogIn, singInUser }= useContext(AuthContext)
    ...
    return (
        <section>
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-base-300 mx-auto mt-10 dark:text-gray-800">
                <h1 className="text-2xl font-bold text-center">Login</h1>
                <form onSubmit={handleLog} noValidate="" action="" className="space-y-6">
                    ...
                    <button type='submit' className="block w-full p-3 btn btn-outline text-center rounded-sm dark:text-gray-50 dark:bg-violet-600">Sign in</button>
                </form>
